...
REM ==============================
REM BVBChecker Starter (CSV mode)
REM ==============================

REM --- Configuration ---
set "APP_DIR=C:\Program Files\BVBChecker"
set "RULES_FORMAT=csv"
set "RULES_CSV=%APP_DIR%\app\rules\diagnoseliste_extracted.csv"
...
if exist "%APP_DIR%\BVBChecker.exe" (
  echo Starting BVBChecker (CSV rules) from "%APP_DIR%"
